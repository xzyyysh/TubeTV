...
public class TelesistemaExtractor {

    private static final String TAG = "TelesistemaExtractor";
            ...
            while (retries < MAX_RETRIES) {
                try {
                    ...
                    String apiUrl = "https://geo.dailymotion.com/video/" + videoId + ".json" +
                            "?legacy=true&embedder=https%3A%2F%2Ftelesistema11.com.do%2F&geo=1";

                    URL url = new URL(apiUrl);
                    HttpURLConnection conn = (HttpURLConnection) url.openConnection();
                    conn.setRequestMethod("GET");
                    conn.setRequestProperty("User-Agent", "Mozilla/5.0 (Linux; Android 10) AppleWebKit/537.36");
                    conn.setRequestProperty("Referer", "https://telesistema11.com.do/");
